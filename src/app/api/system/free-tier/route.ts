...
export async function GET(req: NextRequest) {
  ...
  const services: FreeTierServiceStatus[] = [
    ...
    {
      id: 'database',
      name: 'Cloud Database Store',
      category: 'database',
      provider: 'Firebase Realtime DB / Supabase PostgreSQL',
      plan: 'Firebase Realtime DB & Supabase Free (100% Free)',
      status: 'ONLINE',
      connectionUrl: process.env.NEXT_PUBLIC_FIREBASE_DATABASE_URL || 'https://demo-app-default-rtdb.firebaseio.com',
      pingMs: dbPing || 5,
      quotaLimit: 'Unlimited Realtime DB Nodes & 500 MB SQL Storage',
      quotaUsage: 'Optimal Realtime Connection',
      features: ['Firebase Realtime Persistence', 'PostgreSQL Engine Support', 'Zero-Downtime Serverless Sync', 'Enterprise Multi-Tenant Fallback'],
    },
    {
      id: 'security',
